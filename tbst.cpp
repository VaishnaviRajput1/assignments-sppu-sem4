...
public:
    ...
    cout<<"The Minimum Element from the Tree is: "<< curr->data<<endl;
}
...
void displayLargest(){
    ...
    cout<<"The Maximum Element from the Tree is: "<< curr->data<<endl;
}
...

{
...

    {
        ...
        cout << "5. Displaying smallest in TBST"<<endl;

        cout << "6. Displaying largest in TBST"<<endl;
